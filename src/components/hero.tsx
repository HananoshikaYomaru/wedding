...
const InteractiveContainer = () => {
  ...
  return (
    <div className="relative  mt-12 w-full max-w-md h-48 border-2 border-dashed border-[#d3b8a3] rounded-lg flex items-center justify-center bg-white/50 backdrop-blur-sm">
